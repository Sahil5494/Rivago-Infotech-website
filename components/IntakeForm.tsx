    ...
    >
      ...
      {!submitted ? (
        ...
        <div style={{ textAlign: "center", padding: "30px 0" }}>
          ...
          <div style={{ fontSize: "var(--fz5)", fontWeight: 500, color: "var(--text)", marginBottom: 8 }}>Brief received.</div>
          <div style={{ fontSize: "var(--fz2)", color: "var(--text2)", lineHeight: 1.6, maxWidth: 340, margin: "0 auto" }}>A senior partner is reviewing it now. Expect a calibration-call invite within the hour.</div>
        </div>
      )}
    </form>
  );
