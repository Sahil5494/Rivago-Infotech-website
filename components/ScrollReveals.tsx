...
export default function ScrollReveals() {
  ...
  useEffect(() => {
    ...
    // The homepage carries its own motion (app/_home/HomeClient.tsx) and none of
    // the selectors below exist there — skip it so GSAP is never loaded on the
    // route with the tightest LCP budget.
    if (pathname === "/") return;
