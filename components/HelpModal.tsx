      ...
      <div className="hlp-modal">
        ...
        <div className="hlp-opts">
          <a className="hlp-opt" href={`${routes.hireTalent}#intake`} onClick={openHire}>
            <span className="hlp-ico"><svg width="19" height="19" viewBox="0 0 22 22" fill="none"><circle cx="11" cy="8" r="3.4" stroke="var(--accent)" strokeWidth="1.4" /><path d="M4.5 19c0-3.6 2.9-6.5 6.5-6.5s6.5 2.9 6.5 6.5" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" /></svg></span>
          ...
          <a className="hlp-opt" href={routes.contactUs} onClick={() => setOpen(false)}>
            <span className="hlp-ico"><svg width="19" height="19" viewBox="0 0 22 22" fill="none"><path d="M3 8l8-4 8 4v6l-8 4-8-4z" stroke="var(--accent)" strokeWidth="1.4" strokeLinejoin="round" /><path d="M7 10v3l4 2 4-2v-3" stroke="var(--accent)" strokeWidth="1.4" strokeLinejoin="round" /></svg></span>
          ...
          <a className="hlp-opt" href={routes.services} onClick={() => setOpen(false)}>
            <span className="hlp-ico"><svg width="19" height="19" viewBox="0 0 22 22" fill="none"><circle cx="11" cy="11" r="8" stroke="var(--accent)" strokeWidth="1.4" /><path d="M11 15v.5M11 7.5a2.2 2.2 0 011.9 3.3c-.4.65-1.9 1.1-1.9 2.2" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" /></svg></span>
          ...
          <a className="hlp-opt" href={routes.viewJobs} onClick={() => setOpen(false)}>
            <span className="hlp-ico"><svg width="19" height="19" viewBox="0 0 22 22" fill="none"><rect x="3" y="6.5" width="16" height="11.5" rx="2" stroke="var(--accent)" strokeWidth="1.4" /><path d="M7.5 6.5V5a2 2 0 012-2h3a2 2 0 012 2v1.5" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" /></svg></span>
