    ...
    <>
      ...
      <section className="page-hero">
        <div className="page-hero-inner">
          ...
          <h1 className="gs" style={{ marginTop: 18 }}>Build a career placing <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>other careers.</em></h1>
      ...
      <section className="section alt" id="culture">
        <div className="wrap">
          ...
          <h2 className="section-h2 gs" style={{ marginTop: 18, color: "var(--text)", maxWidth: 620 }}>A firm built for <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>good recruiters.</em></h2>
      ...
      <section className="section alt" id="perks">
        <div className="wrap">
          ...
          <h2 className="section-h2 gs" style={{ marginTop: 18, color: "var(--text)", maxWidth: 620 }}>A grown-up <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>package.</em></h2>
          <div className="perks">
            {perks.map((p) => (
      ...
      <section className="section">
        <div className="wrap">
          ...
          <h2 className="section-h2 gs" style={{ marginTop: 18, color: "var(--text)", maxWidth: 640 }}>What it&apos;s actually like <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>inside.</em></h2>
      ...
      <section className="section cv-sec">
        <div className="wrap">
          ...
          <h2 className="section-h2 gs" style={{ marginTop: 18, color: "var(--text-inv-1)", maxWidth: 640 }}>Four values we <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>actually hire for.</em></h2>
      ...
      <section className="section" id="hiring">
        <div className="wrap">
          ...
          <h2 className="section-h2 gs" style={{ marginTop: 18, color: "var(--text)", maxWidth: 640 }}>How we hire — <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>four honest steps.</em></h2>
