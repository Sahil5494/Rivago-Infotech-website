    ...
    <>
      ...
      <SwhySection
        ...
        cards={[
          ...
          { title: "Scale up or down instantly", desc: "Ramp for a peak, cover a shift, wind down after the season — flex headcount as demand moves, with no long-term commitment.", icon: svgIco('<path d="M4 11h6l-2-2M4 11l4 2M18 11h-6l2-2M18 11l-4 2" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>') },
      ...
      <ModesSection
        ...
        heading={<>Three ways to add<br />on-demand <em>temporary capacity.</em></>}
        modes={[
      ...
      <FaqSection
        heading={<>Temporary staffing, <em>the practical detail.</em></>}
        items={[
