...
export default function TemporaryStaffingPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>Capacity the day<br />you <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>actually need it.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to add<br />on-demand <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>temporary capacity.</em></>}
        modes={[
      ...
      <TestiCreamSection
        heading={<>Temporary teams,<br /><em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent-inv)" }}>in their own words.</em></>}
      ...
      <IntakeBandSection
        heading={<>Tell us what you need.<br /><em style={{ fontStyle: "normal", fontWeight: 500 }}>We&apos;ll do the rest.</em></>}
      ...
      <FaqSection
        heading={<>Temporary staffing, <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>the practical detail.</em></>}
        items={[
