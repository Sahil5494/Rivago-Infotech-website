    ...
    <>
      ...
      <SwhySection
        ...
        cards={[
          ...
          { title: "A built-in handover plan", desc: "Every engagement includes a transition plan from day one — to a permanent hire, back to the incumbent, or to whoever comes next.", icon: svgIco('<path d="M4 11h6l-2-2M4 11l4 2M18 11h-6l2-2M18 11l-4 2" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>') },
          { title: "Confidential by default", desc: "Board-level transitions and sensitive gaps handled discreetly — NDA on request, and no signal to the market until you're ready.", icon: svgIco('<rect x="4" y="9" width="14" height="10" rx="2" stroke="var(--accent)" stroke-width="1.5"/><path d="M7 9V6.5a4 4 0 018 0V9" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round"/>') },
        ]}
      />

      <ModesSection
        eyebrowText="How interim leadership works"
        heading={<>Three ways to bring in<br />an <em>interim leader.</em></>}
        modes={[
      ...
      <IndustriesGrid2Section
        heading={<>Interim leaders across<br /><em>every sector we serve.</em></>}
      ...
      <FaqSection
        heading={<>Interim leadership, <em>straight answers.</em></>}
        items={[
