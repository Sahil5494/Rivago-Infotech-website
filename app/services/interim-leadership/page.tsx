...
export default function InterimLeadershipPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>A day-one operator,<br />not <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>a resume search.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to bring in<br />an <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>interim leader.</em></>}
        modes={[
      ...
      <IndustriesGrid2Section
        heading={<>Interim leaders across<br /><em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>every sector we serve.</em></>}
      ...
      <TestiCreamSection
        heading={<>Interim leaders,<br /><em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>in their own words.</em></>}
      ...
      <FaqSection
        heading={<>Interim leadership, <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>straight answers.</em></>}
        items={[
