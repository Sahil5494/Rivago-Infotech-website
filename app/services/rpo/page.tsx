...
export default function RpoPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>An RPO partner that owns<br />the <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>outcome.</em></>}
      ...
      <section className="section">
        <div className="wrap">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720 }}>Not another agency.<br />An <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>owned program.</em></h2>
      ...
      <section className="section alt">
        <div className="wrap">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720 }}>One partner,<br />three <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>ways to engage.</em></h2>
          </div>
          <RpoModelsTabs />
        </div>
      </section>
      ...
      <IndustriesGrid2Section
        heading={<>RPO programs across<br /><em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>every sector we serve.</em></>}
      ...
      <section className="section cream">
        <div className="wrap">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--dt)", maxWidth: 720 }}>A recruiting engine,<br /><em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent-inv)" }}>handed over in weeks.</em></h2>
          </div>
        ...
        <div className="wrap">
          <div className="gs" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 30, flexWrap: "wrap" }}>
            <div>
              ...
              <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720, marginBottom: 0 }}>RPO, <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>in practice.</em></h2>
            </div>
      ...
      {/* FAQ */}
      <FaqSection
        heading={<>RPO, <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>without the sales gloss.</em></>}
        items={[
