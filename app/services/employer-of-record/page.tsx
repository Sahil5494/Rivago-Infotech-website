...
export default function EmployerOfRecordPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>You found them.<br />We make it <em style={{ fontStyle: "normal", fontWeight: 700 }}>legal.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to put someone<br />on our <em style={{ fontStyle: "normal", fontWeight: 700 }}>payroll.</em></>}
        modes={[
        ...
        <div className="wrap">
          <div className="ptx gs">
            <div>
              ...
              <h2 className="section-h2" style={{ color: "var(--dt)", maxWidth: 560 }}>You&apos;ve got the talent?<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>We&apos;ll make the hire.</em></h2>
      ...
      <IndustriesGrid2Section
        heading={<>Employer of Record across<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>every sector we serve.</em></>}
      ...
      <TestiCreamSection
        heading={<>Compliant hires,<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>in their own words.</em></>}
        ...
        <div className="wrap">
          <div className="gs" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 30, flexWrap: "wrap" }}>
            <div>
              ...
              <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 640 }}>Hiring across borders,<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>made clearer.</em></h2>
            </div>
      ...
      <FaqSection
        heading={<>Employer of Record, <em style={{ fontStyle: "normal", fontWeight: 700 }}>the detail that matters.</em></>}
        items={[
