  ...
  return (
    <>
      ...
      <ModesSection
        ...
        heading={<>Three ways to put someone<br />on our <em>payroll.</em></>}
        modes={[
      ...
      <IndustriesGrid2Section
        heading={<>Employer of Record across<br /><em>every sector we serve.</em></>}
        ...
        <div className="wrap">
          <div className="gs" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 30, flexWrap: "wrap" }}>
            <div>
              ...
              <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 640 }}>Hiring across borders,<br /><em>made clearer.</em></h2>
            </div>
      ...
      <FaqSection
        heading={<>Employer of Record, <em>the detail that matters.</em></>}
        items={[
