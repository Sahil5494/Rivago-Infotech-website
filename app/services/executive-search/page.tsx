...
export default function ExecutiveSearchPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>Leadership searches run<br />by <em style={{ fontStyle: "normal", fontWeight: 700 }}>the partner, not a team.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to run a<br />retained <em style={{ fontStyle: "normal", fontWeight: 700 }}>leadership search.</em></>}
        modes={[
      ...
      <section className="section cream">
        <div className="wrap">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--dt)", maxWidth: 720 }}>Picking the right approach<br />for the <em style={{ fontStyle: "normal", fontWeight: 700 }}>seat you&apos;re filling.</em></h2>
          </div>
      ...
      <IndustriesGrid2Section
        heading={<>Executive search across<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>every sector we serve.</em></>}
      ...
      <TestiCreamSection
        heading={<>Executive searches,<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>in their own words.</em></>}
      ...
      <IntakeBandSection
        heading={<>Tell us the mandate.<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>We&apos;ll do the rest.</em></>}
      ...
      <FaqSection
        heading={<>Executive search, <em style={{ fontStyle: "normal", fontWeight: 700 }}>the questions that matter.</em></>}
        items={[
