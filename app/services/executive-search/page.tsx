    ...
    <>
      ...
      <SwhySection
        ...
        cards={[
          ...
          { title: "One partner, full ownership", desc: "The partner who takes your brief runs every call and every reference — no handoffs to researchers, no relay through account managers.", icon: svgIco('<circle cx="11" cy="8" r="3.5" stroke="var(--accent)" stroke-width="1.5"/><path d="M4 19c0-3.9 3.1-7 7-7s7 3.1 7 7" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round"/>') },
          { title: "Full market mapping", desc: "Every credible leader in your space is mapped and approached directly — not just the ones who happen to be looking.", icon: svgIco('<path d="M11 2l2.2 4.4 4.8.7-3.5 3.4.8 4.8L11 13l-4.3 2.3.8-4.8L4 7.1l4.8-.7z" stroke="var(--accent)" stroke-width="1.5" stroke-linejoin="round"/>') },
          { title: "Weekly written briefings", desc: "A short, honest status update every week — who we've approached, who's interested, and where the search really stands.", icon: svgIco('<path d="M4 11h6l-2-2M4 11l4 2M18 11h-6l2-2M18 11l-4 2" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>') },
        ]}
      />

      <ModesSection
        eyebrowText="How executive search works"
        heading={<>Three ways to run a<br />retained <em>leadership search.</em></>}
        modes={[
      ...
      <section className="section cream">
        <div className="wrap">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--dt)", maxWidth: 720 }}>Picking the right approach<br />for the <em>seat you&apos;re filling.</em></h2>
          </div>
      ...
      <IndustriesGrid2Section
        heading={<>Executive search across<br /><em>every sector we serve.</em></>}
      ...
      <FaqSection
        heading={<>Executive search, <em>the questions that matter.</em></>}
        items={[
