...
export default function DirectHirePage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>Built for teams that can&apos;t<br />afford <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>the wrong hire.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to run a<br />permanent <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>direct-hire search.</em></>}
        modes={[
      ...
      <TestiCreamSection
        heading={<>Permanent hires,<br /><em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>in their own words.</em></>}
      ...
      <FaqSection
        heading={<>Direct hire, <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>answered properly.</em></>}
        items={[
