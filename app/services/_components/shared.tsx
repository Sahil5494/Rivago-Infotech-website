...
export const BulletCheck = () => (
  <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
    <path d="M1 6l4 4L13 1" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const DeliverCheck = () => (
  <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
    <path d="M3 8.5l3.2 3.2L13 5" stroke="var(--accent)" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const IconPartner = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="8" r="3.5" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M4 19c0-3.9 3.1-7 7-7s7 3.1 7 7" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);

export const IconBadge = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M11 2l2 5 5 .7-3.6 3.5.9 5L11 13.5l-4.3 2.5.9-5L4 7.7l5-.7z" stroke="var(--accent)" strokeWidth="1.5" strokeLinejoin="round" />
  </svg>
);

export const IconClock = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="8" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M11 7v4l3 2" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);

export const IconShield = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M11 2l8 4v5c0 5-3.5 8.5-8 9.5C6.5 19.5 3 16 3 11V6z" stroke="var(--accent)" strokeWidth="1.5" strokeLinejoin="round" />
  </svg>
);
...
export const IconShieldCheck = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M11 2l8 4v5c0 5-3.5 8.5-8 9.5C6.5 19.5 3 16 3 11V6z" stroke="var(--accent)" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M7.5 11.2l2.2 2.2 4.3-4.3" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const IconGlobe = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="8" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M2 11h18M11 3a13 13 0 010 16M11 3a13 13 0 000 16" stroke="var(--accent)" strokeWidth="1.5" />
  </svg>
);

export const IconGuarantee = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <rect x="3" y="6" width="16" height="13" rx="2" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M7 6V4a2 2 0 012-2h4a2 2 0 012 2v2M7 12l3 3 6-6" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const IconScaleFlex = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M6 15V7M6 7L3 10M6 7l3 3" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M16 7v8M16 15l3-3M16 15l-3-3" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const IconDoc = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M6 2h7l4 4v14a1 1 0 01-1 1H6a1 1 0 01-1-1V3a1 1 0 011-1z" stroke="var(--accent)" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M13 2v4h4M7.5 12h7M7.5 15.5h5" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);
...
export const IconMoney = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="8" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M11 6.5v9M13.5 8.5c0-1-1.1-1.8-2.5-1.8s-2.5.75-2.5 1.8c0 2.4 5 1.2 5 3.6 0 1.05-1.1 1.9-2.5 1.9s-2.5-.85-2.5-1.9" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);

export const IconHeart = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M11 19s-7.2-4.5-9.2-9.1C.5 6.8 2 3.5 5.4 3c2-.3 3.8.8 5.6 2.7C12.8 3.8 14.6 2.7 16.6 3c3.4.5 4.9 3.8 3.6 6.9C18.2 14.5 11 19 11 19z" stroke="var(--accent)" strokeWidth="1.4" strokeLinejoin="round" />
  </svg>
);

export const IconBuilding = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <rect x="4" y="3" width="10" height="17" rx="1" stroke="var(--accent)" strokeWidth="1.5" />
    <rect x="14" y="9" width="5" height="11" rx="1" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M7 7h2M7 11h2M7 15h2" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);
...
export const IconTarget = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="8" stroke="var(--accent)" strokeWidth="1.5" />
    <circle cx="11" cy="11" r="4" stroke="var(--accent)" strokeWidth="1.5" />
    <circle cx="11" cy="11" r="1" fill="var(--accent)" />
  </svg>
);

export const IconHandshake = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M2 10l4-4 4 2 3-2 5 3-3 5-2-1-3 3-6-3" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const IconTeam = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="7.5" cy="7.5" r="3" stroke="var(--accent)" strokeWidth="1.4" />
    <circle cx="15" cy="9" r="2.3" stroke="var(--accent)" strokeWidth="1.4" />
    <path d="M2.5 19c0-3 2.2-5.4 5-5.4s5 2.4 5 5.4M13.8 19c0-2.3 1.7-4.1 3.6-4.1s3.6 1.8 3.6 4.1" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);

export const IconLightning = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M12 2L4 13h6l-1 7 9-12h-6l1-6z" stroke="var(--accent)" strokeWidth="1.4" strokeLinejoin="round" />
  </svg>
);

export const IconChart = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <path d="M3 19V9M9 19V4M15 19v-7M19 19V2" stroke="var(--accent)" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);
...
export const IconCompass = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="8" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M14 8l-2 6-4-1.7L9.5 6z" stroke="var(--accent)" strokeWidth="1.3" strokeLinejoin="round" />
  </svg>
);

export const IconKey = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="7" cy="15" r="3.5" stroke="var(--accent)" strokeWidth="1.5" />
    <path d="M9.5 12.5L18 4M15 7l2 2M17.5 4.5l2 2" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
      ...
      <div className="wrap">
        ...
        <div className="tc-card gs" style={{ maxWidth: 800, margin: "48px auto 0", padding: "44px 42px" }}>
          ...
          <div className="tc-author2">
            <div style={{ width: 42, height: 42, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", background: "var(--grad-brand)", color: "var(--on-accent)", fontWeight: 500, fontSize: "var(--fz2)", letterSpacing: ".02em" }}>{initials}</div>
            <div><div className="tc-author2-name">{name}</div><div className="tc-author2-role">{role}</div></div>
          </div>
          {metrics && metrics.length > 0 && (
            <div style={{ display: "flex", gap: 32, marginTop: 28, paddingTop: 24, borderTop: "1px solid var(--rule-1)", flexWrap: "wrap" }}>
              {metrics.map((m) => (
                <div key={m.label}>
          ...
          {cards.map((c) => (
            <div className="tc-card gs" key={c.name}>
              ...
              <div className="tc-author">
                <div className="tc-author-av" style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "var(--grad-brand)", color: "var(--on-accent)", fontWeight: 500, fontSize: "var(--fz2)", letterSpacing: ".02em" }}>{c.initials}</div>
