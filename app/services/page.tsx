        ...
        <section className="why">
          <div className="why-inner">
            ...
            <div className="why-grid">
              <div className="why-card rv"><div className="why-ico"><svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M11 2l2.2 4.4 4.8.7-3.5 3.4.8 4.8L11 13l-4.3 2.3.8-4.8L4 7.1l4.8-.7z" stroke="var(--accent)" strokeWidth="1.5" strokeLinejoin="round" /></svg></div><h3>Senior recruiters only</h3><p>Every search is run by a specialist with 7+ years in your field — no juniors learning on your role.</p></div>
              <div className="why-card rv rv2"><div className="why-ico"><svg width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="9" cy="9" r="6" stroke="var(--accent)" strokeWidth="1.5" /><path d="M14 14l5 5" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" /></svg></div><h3>Access to hidden talent</h3><p>A private network of senior operators who never touch a job board — reached directly, on your behalf.</p></div>
              <div className="why-card rv rv3"><div className="why-ico"><svg width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="7" cy="8" r="3" stroke="var(--accent)" strokeWidth="1.5" /><circle cx="15" cy="8" r="3" stroke="var(--accent)" strokeWidth="1.5" /><path d="M2 18c0-2.5 2-4.5 4.5-4.5M20 18c0-2.5-2-4.5-4.5-4.5" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" /></svg></div><h3>Inclusive shortlists</h3><p>Calibrated scorecards and diverse, fairly-assessed slates on every role — bias designed out from the brief.</p></div>
              <div className="why-card rv rv4"><div className="why-ico"><svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M11 19s-7-4.2-7-9a4 4 0 017-2.6A4 4 0 0118 10c0 4.8-7 9-7 9z" stroke="var(--accent)" strokeWidth="1.5" strokeLinejoin="round" /></svg></div><h3>Care past the offer</h3><p>Structured check-ins at 3, 6 and 12 months — we stay invested long after the placement is made.</p></div>
            </div>
          </div>
        </section>
          ...
          <div className="eng-inner">
            ...
            <div className="eng-grid">
              ...
              <div className="eng-card rv rv3">
                ...
                <ul className="eng-list"><li><svg width="14" height="12" viewBox="0 0 14 12" fill="none"><path d="M1 6l4 4L13 1" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>Deployed in days, not weeks</li><li><svg width="14" height="12" viewBox="0 0 14 12" fill="none"><path d="M1 6l4 4L13 1" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>Payroll &amp; compliance handled</li><li><svg width="14" height="12" viewBox="0 0 14 12" fill="none"><path d="M1 6l4 4L13 1" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>Scale up or down anytime</li></ul>
              </div>
            </div>
          </div>
        </section>

        <section className="rls lt">
        ...
        <section className="svcta inv">
          <div className="svcta-inner rv">
            ...
            <div style={{display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap"}}>
              <a className="btn-dark" href="/hire-talent#intake" data-help>Let&apos;s Talk <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="#030C05" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></a>
