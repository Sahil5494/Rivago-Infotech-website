...
export default function ContractStaffingPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>Flexible capacity, without<br />the <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>compliance headache.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to add<br />flexible <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>contract capacity.</em></>}
        modes={[
      ...
      <TestiCreamSection
        heading={<>Contract talent,<br /><em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent-inv)" }}>in their own words.</em></>}
      ...
      <IntakeBandSection
        heading={<>Tell us the roles.<br /><em style={{ fontStyle: "normal", fontWeight: 500 }}>We&apos;ll do the rest.</em></>}
      ...
      <FaqSection
        heading={<>Contract staffing, <em style={{ fontStyle: "normal", fontWeight: 500, color: "var(--accent)" }}>the real questions.</em></>}
        items={[
