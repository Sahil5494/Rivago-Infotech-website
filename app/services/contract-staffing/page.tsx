    ...
    <>
      ...
      <SwhySection
        ...
        cards={[
          ...
          { title: "Payroll & compliance, on us", desc: "We become the employer of record for every contractor — payroll, taxes, benefits, insurance and IR35/worker classification handled in-country.", icon: svgIco('<rect x="3" y="6" width="16" height="12" rx="2" stroke="var(--accent)" stroke-width="1.5"/><path d="M3 10h16M7 3v3" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round"/>') },
          { title: "Deployed in days", desc: "A standing bench of pre-vetted, references-checked contractors means most roles are filled and productive inside a working week.", icon: svgIco('<circle cx="11" cy="11" r="8" stroke="var(--accent)" stroke-width="1.5"/><path d="M11 7v4l3 2" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round"/>') },
          { title: "Convert when you're ready", desc: "Every contractor can move to permanent with no conversion fee after an agreed period — try before you commit, keep the ones who fit.", icon: svgIco('<path d="M4 11h6l-2-2M4 11l4 2M18 11h-6l2-2M18 11l-4 2" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>') },
        ]}
      />
