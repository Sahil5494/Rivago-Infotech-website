...
export default function ContractStaffingPage() {
  return (
    <>
      ...
      <SwhySection
        heading={<>Flexible capacity, without<br />the <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>compliance headache.</em></>}
      ...
      <ModesSection
        ...
        heading={<>Three ways to add<br />flexible <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>contract capacity.</em></>}
        modes={[
      ...
      <TestiCreamSection
        heading={<>Contract talent,<br /><em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>in their own words.</em></>}
      ...
      <FaqSection
        heading={<>Contract staffing, <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>the real questions.</em></>}
        items={[
