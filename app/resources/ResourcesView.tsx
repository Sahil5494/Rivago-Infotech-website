...
function NewsletterInline() {
  ...
  if (ok) return <span style={{ padding: "8px 16px", fontSize: "var(--fz2)", color: "#0A7040", fontWeight: 600 }}>Subscribed ✓</span>;
  return (
    <form
      className="rsub-form"
      onSubmit={(e) => {
  ...
  return (
    <section className="bg-news">
      <div className="bg-news-inner">
        ...
        <p>{sub}</p>
        {ok ? (
          <div style={{ padding: "11px 18px", fontSize: "var(--fz3)", color: "#0A7040", fontWeight: 600 }}>Subscribed — your first brief is on its way.</div>
        ) : (
          <form
        ...
        <>
          <div className="rfeat">
            <div className="rfeat-img" style={{ background: "linear-gradient(135deg,#A6F0CE,#3DA9FF)" }}>
              ...
              <div style={{ position: "absolute", left: 32, bottom: 30, width: 34, height: 34, borderRadius: "50%", background: "rgba(255,255,255,.22)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 700, fontSize: "var(--fz2)" }}>R</div>
            </div>
            <div>
