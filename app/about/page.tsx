      ...
      <section className="belief gs">
        <div className="belief-inner">
          <div>
            ...
            <h2 style={{ marginTop: 18, fontSize: "var(--fz10)", lineHeight: 1.08, letterSpacing: "-.024em", fontWeight: 400, color: "var(--dt)", maxWidth: 320 }}>A different kind of <em>recruitment firm.</em></h2>
          </div>
