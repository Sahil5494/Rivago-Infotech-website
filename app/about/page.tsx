      ...
      <section className="belief gs">
        <div className="belief-inner">
          <div>
            ...
            <h2 style={{ marginTop: 18, fontSize: "var(--fz10)", lineHeight: 1.08, letterSpacing: "-.024em", fontWeight: 400, color: "var(--dt)", maxWidth: 320 }}>A different kind of <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>recruitment firm.</em></h2>
          </div>
          <div className="belief-body">
            ...
            <p>The search industry built itself around <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>volume.</em> More résumés. More portals. More &ldquo;candidates per requisition.&rdquo; We came up inside it and watched the work degrade for both sides — hiring managers drowning in unscreened profiles, candidates ignored after their fourth round.</p>
            ...
            <p>It costs more per hire. It also <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>sticks.</em> Ninety-one percent of the people we place are still in seat twelve months later.</p>
          </div>
        </div>
      </section>
      ...
      <section className="numbers gs">
        <div className="numbers-inner">
          <div style={{ marginBottom: 56 }}>
            ...
            <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720, marginBottom: 0 }}>Nearly a decade of <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>placed hires.</em></h2>
          </div>
      ...
      <section className="timeline">
        <div className="timeline-inner">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720, marginBottom: 0 }}>The decisions that <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>made the firm.</em></h2>
          </div>
      ...
      <section className="leaders" id="leadership">
        <div className="leaders-inner">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720, marginBottom: 0 }}>The eight people whose<br />names go on the <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent)" }}>first call.</em></h2>
          </div>
      ...
      <section className="values">
        <div className="values-inner">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--dt)", maxWidth: 720, marginBottom: 0 }}>Four principles.<br /><em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>No exceptions.</em></h2>
          </div>
          <div className="values-grid values-grid-4">
            {principles.map((v, i) => (
              <div className="value gs" key={v.title}>
                ...
                <h3>{v.title} <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>{v.em}</em></h3>
                <p>{v.desc}</p>
              </div>
            ))}
          </div>
      ...
      <section className="values" style={{ background: "var(--cream)" }}>
        <div className="values-inner">
          <div className="gs">
            ...
            <h2 className="section-h2" style={{ color: "var(--dt)", maxWidth: 720, marginBottom: 0 }}>Our values, mostly stated<br />as the <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>things we refuse.</em></h2>
          </div>
          <CardSlider trackClassName="values-grid values-grid-divider" nav="dots">
            {refusals.map((v, i) => (
              <div className="value gs" key={v.title} style={{ background: "var(--cream)" }}>
                <div className="value-num">{String(i + 1).padStart(2, "0")}</div>
                <h3>{v.title}<br />{v.titleBreak} <em style={{ fontFamily: "var(--fs)", fontStyle: "italic", color: "var(--accent-inv)" }}>{v.em}</em></h3>
                <p>{v.desc}</p>
              </div>
            ))}
          </CardSlider>
