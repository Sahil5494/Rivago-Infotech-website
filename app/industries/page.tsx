    ...
    <>
      ...
      <section className="section" style={{ borderTop: "1px solid var(--border)" }}>
        <div className="wrap gs">
          ...
          <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 760, marginBottom: 22 }}>Ten practices.<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>One search methodology.</em></h2>
        ...
        <div className="wrap gs">
          <div className="ind-writing-head" style={{ gap: 80, alignItems: "end", marginBottom: 56 }}>
            <div>
              ...
              <h2 className="section-h2" style={{ color: "var(--text-inv-1)" }}>Four numbers we&apos;ll stand behind<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>on the first call.</em></h2>
            </div>
      ...
      <section className="section">
        <div className="wrap gs">
          ...
          <h2 className="section-h2" style={{ color: "var(--text)", maxWidth: 720, marginBottom: 22 }}>Notes from the<br /><em style={{ fontStyle: "normal", fontWeight: 700 }}>other side of the table.</em></h2>
